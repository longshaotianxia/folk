...
public class SessionAggrStat {
    ...
    public double getVisit_length_60m_ratio() {
        return visit_length_60m_ratio;
    }

    public void setVisit_length_60m_ratio(double visit_length_60m_ratio) {
        this.visit_length_60m_ratio = visit_length_60m_ratio;
    }
    ...
    public double getVisit_length_ls_3s_ratio() {
        return visit_length_ls_3s_ratio;
    }

    public void setVisit_length_ls_3s_ratio(double visit_length_ls_3s_ratio) {
        this.visit_length_ls_3s_ratio = visit_length_ls_3s_ratio;
    }
    ...
    public double getVisit_length_l0s_30s_ratio() {
        return visit_length_l0s_30s_ratio;
    }

    public void setVisit_length_l0s_30s_ratio(double visit_length_l0s_30s_ratio) {
        this.visit_length_l0s_30s_ratio = visit_length_l0s_30s_ratio;
    }
    ...
    public double getVisit_length_lm_3m_ratio() {
        return visit_length_lm_3m_ratio;
    }

    public void setVisit_length_lm_3m_ratio(double visit_length_lm_3m_ratio) {
        this.visit_length_lm_3m_ratio = visit_length_lm_3m_ratio;
    }
    ...
    public double getStep_length_l_3_ratio() {
        return step_length_l_3_ratio;
    }

    public void setStep_length_l_3_ratio(double step_length_l_3_ratio) {
        this.step_length_l_3_ratio = step_length_l_3_ratio;
    }
    ...
    public double getStep_length_l0_30_ratio() {
        return step_length_l0_30_ratio;
    }

    public void setStep_length_l0_30_ratio(double step_length_l0_30_ratio) {
        this.step_length_l0_30_ratio = step_length_l0_30_ratio;
    }
