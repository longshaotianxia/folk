...
import com.fengde.sparkproject.util.*;
...
public class UserVisitSessionAnalyzeSpark {
    ...
    public static void main(String[] args) {
       ...
       SparkUtils.mockData(sc,sqlContext);
        ...
        if(task == null){
            System.out.print(new Date() + ": cannot find this task with id [" + taskid + "].");
            return;
        }
    ...
    private static void calculateAndPersistAggrStat(String value, long taskid) {
        ...
        sessionAggrStat.setVisit_length_ls_3s_ratio( visit_length_1s_3s_ratio );
        sessionAggrStat.setVisit_length_4s_6s_ratio( visit_length_4s_6s_ratio );
        sessionAggrStat.setVisit_length_7s_9s_ratio( visit_length_7s_9s_ratio );
        sessionAggrStat.setVisit_length_l0s_30s_ratio( visit_length_1s_3s_ratio );
        sessionAggrStat.setVisit_length_30s_60s_ratio( visit_length_30s_60s_ratio );
        sessionAggrStat.setVisit_length_lm_3m_ratio( visit_length_1s_3s_ratio );
        sessionAggrStat.setVisit_length_3m_10m_ratio( visit_length_3m_10m_ratio );
        sessionAggrStat.setVisit_length_10m_30m_ratio( visit_length_10m_30m_ratio );
        sessionAggrStat.setVisit_length_30m_ratio( visit_length_30m_ratio );
        sessionAggrStat.setStep_length_l_3_ratio( visit_length_1s_3s_ratio );
        sessionAggrStat.setStep_length_4_6_ratio( step_length_4_6_ratio );
        sessionAggrStat.setStep_length_7_9_ratio( step_length_7_9_ratio );
        sessionAggrStat.setStep_length_l0_30_ratio( visit_length_1s_3s_ratio );
