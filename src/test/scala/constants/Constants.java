...
public interface Constants {
    ...
    String KAFKA_METADATA_BROKE_LIST = "kafka.metdata.broke.list";
    ...
    String FIELD_STEP_LENGTH = "setpLength";
    ...
    String JDBC_URL_PROD = "prod";
    String JDBC_USER_PROD = "userprod";
    String JDBC_PASSWORD_PROD = "passwordprod";
    String KAFKA_METADATA_BROKER_LIST = "metadatabrokerlist";
