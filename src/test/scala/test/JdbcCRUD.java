...
//		select();
    ...
    private static void insert() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/spark_project", "root", "123456");
    ...
    private static void preparedStatement() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/spark_project?characterEncoding=utf8", "root", "123456");
